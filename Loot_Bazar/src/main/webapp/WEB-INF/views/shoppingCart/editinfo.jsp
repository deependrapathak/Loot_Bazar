...
<form:form modelAttribute="user" action="/Loot_Bazar/editinfo" method="post">
...
<td><form:input path="dob" placeholder="mm/dd/yyyy" readonly="true"/></td>
<td><form:errors path="dob" cssStyle="color:red"/></td>
</tr>
<tr>
<td><spring:message code="customer.username" /></td>
<td><form:input path="user.username" readonly="true"/></td>
